	...
	Prop *_prop;
{
	...
	double *_p; Datum *_ppvar;
 	_p = (double *)ecalloc(9, sizeof(double));
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
 	...
 	ivoc_help("help ?1 kap /home/rcc/PSICS/eclipse/Examples/src/org/psics/examples/migca1/nrn/i386/kaprox.mod\n");
