...
public class XMLReader {
   ...
   public Object readObject(String s) throws ParseException, BuildException {
      return readFromString(s);
   }


   public Object read(String s) throws ParseException, BuildException {
      return readFromString(s);
   }



   public Object readFromString(String sin) throws ParseException, BuildException {
	   String s = sin;
   ...
   public String readBlock(XMLTokenizer tkz, XMLToken opener) throws ParseException {
	   ...
	   while (true) {
		   ...
		   if (wkt == null) {
			   E.error("no closing token for " + opener + "?");
			   break;
   ...
   public void readFieldIntoParent(XMLTokenizer tkz, Object parent, XMLToken start,
		   Parameterized rootPtzd) throws ParseException, BuildException {
               ...
               if (next.isNone()) {
                  ...
                  // or object, but in any case, pass them back to this method;
            	   if (child instanceof XMLContainer) {
            		   ...
            		   /* need to queue tokens for this - is it a good thing to do? TODO probabvly not - doesn't nest
