...
public class Reflector {
   ...
   public static Element makeObjectElementByReflection(Object obj,
      ...
      String dblFormat = elementizer.getDoubleFormat();
      ...
      */
      ...
      if (ctxt.shouldWritePackage(spk)) {
      ...
      for (Field field : af) {
         ...
         if (name.startsWith("p_") || name.startsWith("r_")) {
            ...
            Object val = getFieldValue(field, obj, dblFormat);
            if (val == null) {
         ...
         //   } else if (val instanceof Stateless) {
            ...
            } else if (val instanceof StringValued) {
                attributes.add(new OmAttribute(name, ((StringValued)val).getStringValue()));
               ...
               if (ctxt.recurseAll() || val instanceof int[][] || val instanceof double[][]) {
                  ...
                  if (omelt != null) {
                     ...
                     if (!omelt.hasAttributes() && omelt.getName().startsWith("c_")) { // ADHOC c_ convention
               		     List<Element> le = omelt.getElements();
               		     if (le != null) {
               		    	 for (Element chelt : le) {
               		    		 elements.add(chelt);
               		    	 }
               		     }
   ...
   public static Object getFieldValue(Field field, Object obj, String dblFormat) {
      ...
      return SerialUtil.stringifyObject(val, dblFormat);
   }
